...
**Правила changelog:**
- Дата і час — реальні, **за німецьким місцевим часом (Europe/Berlin, CET/CEST)**. Не UTC. Влітку це UTC+2, взимку UTC+1. Якщо поточний час невідомий точно — вказати дату і приблизний час або запитати у користувача.

<footer style="max-width: 800px; margin: 40px auto 20px; padding: 0 16px; text-align: center; font-family: 'Albert Sans', sans-serif;">
    <div style="font-size: 11px; color: #9ca3af; line-height: 1.6; margin-bottom: 16px;">
